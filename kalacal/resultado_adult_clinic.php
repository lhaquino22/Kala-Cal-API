...
<center>
  <table width="55%" border="0" align="center">
    ...
    <tr bgcolor="#FFFFFF">
      <td class="subtitulo">Clinical model, faixa age range: <? echo $faixaEtaria ?> (<a href="index.php">switch</a>)</td>
    </tr>
    <tr>
      <td></td>
    </tr>
    ...
    <tr>
      <td class="subtitulo"><table width="50%" border="0" align="center" cellpadding="1" cellspacing="1">
        ...
        <tr bgcolor="#CCCCCC">
          <td class="campos">Score: <span class="realce"><? echo $paciente->getEscore().'/13';?></span></td>
        </tr>
        <tr bgcolor="#CCCCCC">
          <td class="campos">Probability of death: <span class="realce"><? 
              $temp=$modelo->probMorteMaior2anosClinico($paciente->getEscore());
              $mgs="erro";
              if($temp!=-1){ echo ($temp*100).'%';} else {echo $mgs;} ?></span></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td class="subtitulo"><img src="imagens/graf_adult_clinic.jpg" width="673" height="408" /></td>
    </tr>
  </table>
</center>
