...
if(isset($_POST['sangramento'])){
	...
	$paciente->calcularEscoreLaboratorialCrianca();
...
<center>
  <table width="55%" border="0" align="center">
    ...
    <tr bgcolor="#FFFFFF">
      <td class="subtitulo">Clinical and <span class="destac">laboratorial</span> model, age range: <? echo $faixaEtaria ?> (<a href="index.php">switch</a>)</td>
    </tr>
    <tr>
      <td></td>
    </tr>
    ...
    <tr>
      <td class="subtitulo"><table width="50%" border="0" align="center" cellpadding="1" cellspacing="1">
        ...
        <tr bgcolor="#CCCCCC">
          <td class="campos">Score: <span class="realce"><? echo $paciente->getEscore().'/11';?></span></td>
        </tr>
        <tr bgcolor="#CCCCCC">
          <td class="campos">Probability of death: <span class="realce"><? echo ($modelo->probMorteMenor2anosClinicoElaboratorial($paciente->getEscore())*100).'%';?></span></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td class="subtitulo"><img src="imagens/graf_child_clinic_lab.jpg" width="673" height="408" /></td>
    </tr>
  </table>
</center>
