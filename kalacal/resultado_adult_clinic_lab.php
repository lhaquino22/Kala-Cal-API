...
switch($id){
   ...
   case 3: $faixaEtaria = '2 - 15 anos';break;
   case 4: $faixaEtaria = '16 - 40 anos';break;
...
<center>
  <table width="55%" border="0" align="center">
    ...
    <tr bgcolor="#FFFFFF">
      <td class="subtitulo">Clínical and <span class="destac">laboratorial</span> model, age range: <? echo $faixaEtaria ?> (<a href="index.php">switch</a>)</td>
    </tr>
    <tr>
      <td></td>
    </tr>
    ...
    <tr>
      <td class="subtitulo"><span class="titulo">RESULTS:</span></td>
    </tr>
    <tr>
      <td class="subtitulo"><table width="50%" border="0" align="center" cellpadding="1" cellspacing="1">
        ...
        <tr bgcolor="#CCCCCC">
          <td class="campos">Score: <span class="realce"><? echo $paciente->getEscore().'/10';?></span></td>
        </tr>
        <tr bgcolor="#CCCCCC">
          <td class="campos">Probabitily of death: <span class="realce"><? echo ($modelo->probMorteMaior2anosClinicoElaboratorial($paciente->getEscore())*100).'%';?></span></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td class="subtitulo"><img src="imagens/graf_adult_clinic_lab.jpg" width="727" height="408" /></td>
    </tr>
  </table>
</center>
